    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-signin" method="POST" enctype="multipart/form-data" action="../functions/delete.php?candidate_id=<?php echo $row['candidate_id']; ?>">
                    <?php
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-danger" name="deleteCandidate"><i class="fas fa-trash"></i> Delete</button>
